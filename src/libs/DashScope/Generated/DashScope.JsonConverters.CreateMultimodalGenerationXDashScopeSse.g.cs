...
{
    /// <inheritdoc />
    public sealed class CreateMultimodalGenerationXDashScopeSseJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::DashScope.CreateMultimodalGenerationXDashScopeSse>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::DashScope.CreateMultimodalGenerationXDashScopeSseExtensions.ToValueString(value));
        }
    }
}
