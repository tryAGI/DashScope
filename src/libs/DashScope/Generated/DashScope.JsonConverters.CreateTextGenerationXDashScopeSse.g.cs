...
{
    /// <inheritdoc />
    public sealed class CreateTextGenerationXDashScopeSseJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::DashScope.CreateTextGenerationXDashScopeSse>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::DashScope.CreateTextGenerationXDashScopeSseExtensions.ToValueString(value));
        }
    }
}
