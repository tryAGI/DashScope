...
namespace DashScope
{
    public partial class EmbeddingsClient
    {
        ...
        private static readonly global::DashScope.EndPointSecurityRequirement s_CreateMultimodalEmbeddingSecurityRequirement0 =
        ...
        private static readonly global::DashScope.EndPointSecurityRequirement[] s_CreateMultimodalEmbeddingSecurityRequirements =
            new global::DashScope.EndPointSecurityRequirement[]
            {                s_CreateMultimodalEmbeddingSecurityRequirement0,
            };
        partial void PrepareCreateMultimodalEmbeddingArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? xDashScopeWorkSpace,
            global::DashScope.EmbeddingRequest request);
        partial void PrepareCreateMultimodalEmbeddingRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? xDashScopeWorkSpace,
            global::DashScope.EmbeddingRequest request);
        partial void ProcessCreateMultimodalEmbeddingResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateMultimodalEmbeddingResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::DashScope.EmbeddingResponse> CreateMultimodalEmbeddingAsync(
        ...
        {
            var __response = await CreateMultimodalEmbeddingAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DashScope.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DashScope.AutoSDKHttpResponse<global::DashScope.EmbeddingResponse>> CreateMultimodalEmbeddingAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateMultimodalEmbeddingArguments(
            ...
            var __authorizations = global::DashScope.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateMultimodalEmbeddingSecurityRequirements,
                operationName: "CreateMultimodalEmbeddingAsync");
            ...
            if (xDashScopeWorkSpace != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateMultimodalEmbeddingRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::DashScope.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::DashScope.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreateMultimodalEmbeddingAsync",
                                pathTemplate: "\"/services/embeddings/multimodal-embedding/multimodal-embedding\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateMultimodalEmbeddingResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::DashScope.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateMultimodalEmbeddingResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::DashScope.EmbeddingResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::DashScope.AutoSDKHttpResponse<global::DashScope.EmbeddingResponse>(
                                ...
                                {
                                    throw global::DashScope.ApiException.Create(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::DashScope.EmbeddingResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::DashScope.EmbeddingResponse> CreateMultimodalEmbeddingAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::DashScope.EmbeddingRequest
            {
                Model = model,
                Input = input,
            ...
            return await CreateMultimodalEmbeddingAsync(
                xDashScopeWorkSpace: xDashScopeWorkSpace,
                request: __request,
                requestOptions: requestOptions,
