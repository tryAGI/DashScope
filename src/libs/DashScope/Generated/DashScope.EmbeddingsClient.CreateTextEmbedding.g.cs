...
namespace DashScope
{
    public partial class EmbeddingsClient
    {
        ...
        private static readonly global::DashScope.EndPointSecurityRequirement s_CreateTextEmbeddingSecurityRequirement0 =
        ...
        private static readonly global::DashScope.EndPointSecurityRequirement[] s_CreateTextEmbeddingSecurityRequirements =
            new global::DashScope.EndPointSecurityRequirement[]
            {                s_CreateTextEmbeddingSecurityRequirement0,
            };
        partial void PrepareCreateTextEmbeddingArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? xDashScopeWorkSpace,
            global::DashScope.EmbeddingRequest request);
        partial void PrepareCreateTextEmbeddingRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? xDashScopeWorkSpace,
            global::DashScope.EmbeddingRequest request);
        partial void ProcessCreateTextEmbeddingResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateTextEmbeddingResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::DashScope.EmbeddingResponse> CreateTextEmbeddingAsync(
        ...
        {
            var __response = await CreateTextEmbeddingAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DashScope.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DashScope.AutoSDKHttpResponse<global::DashScope.EmbeddingResponse>> CreateTextEmbeddingAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateTextEmbeddingArguments(
            ...
            var __authorizations = global::DashScope.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateTextEmbeddingSecurityRequirements,
                operationName: "CreateTextEmbeddingAsync");
            ...
            if (xDashScopeWorkSpace != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateTextEmbeddingRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::DashScope.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::DashScope.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreateTextEmbeddingAsync",
                                pathTemplate: "\"/services/embeddings/text-embedding/text-embedding\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateTextEmbeddingResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::DashScope.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateTextEmbeddingResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await CreateTextEmbeddingAsync(
                xDashScopeWorkSpace: xDashScopeWorkSpace,
                request: __request,
                requestOptions: requestOptions,
