...
namespace DashScope
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::DashScope.AutoSDKRetryOptions Retry { get; set; } = new global::DashScope.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::DashScope.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::DashScope.IAutoSDKHook>();
        ...
        public global::DashScope.AutoSDKClientOptions AddHook(
            global::DashScope.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::DashScope.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::DashScope.AutoSDKClientOptions UseAuthorizationProvider(
            global::DashScope.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::DashScope.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::DashScope.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::DashScope.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::DashScope.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::DashScope.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::DashScope.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::DashScope.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::DashScope.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::DashScope.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::DashScope.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::DashScope.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::DashScope.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::DashScope.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::DashScope.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::DashScope.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::DashScope.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::DashScope.AutoSDKClientOptions clientOptions,
            global::DashScope.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::DashScope.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::DashScope.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::DashScope.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::DashScope.AutoSDKClientOptions clientOptions,
            global::System.Func<global::DashScope.IAutoSDKHook, global::DashScope.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::DashScope.AutoSDKHookContext context)
        {
