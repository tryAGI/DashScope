...
namespace DashScope
{
    public partial class GenerationClient
    {
        ...
        {
            var __response = await CreateMultimodalGenerationAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::DashScope.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::DashScope.AutoSDKHttpResponse<global::DashScope.DashScopeResponse>> CreateMultimodalGenerationAsResponseAsync(
